...
export function renderHeader(containerId, { onOpenDictionary, onOpenRegistry, onOpenCrosswalk, onOpenIngestion }) {
  ...
  container.innerHTML = `
    ...
    <header class="bg-white px-[7px] pt-2.5 pb-1 flex items-center justify-end flex-wrap gap-2">
      <!-- Action Navigation Buttons -->
      <div class="flex items-center gap-2 flex-wrap ml-auto">
        <button id="btn-header-crosswalk-doc" class="gov-btn text-xs font-medium bg-[#EBF1FC] text-[#0038A8] border-[#BCD0F7] hover:bg-[#DCE7FA]">
          <span>ℹ️</span>
          <span>Riwayat Klasifikasi APBN</span>
        </button>

        <button id="btn-header-dict" class="gov-btn text-xs font-medium bg-white border-[#E5DACF] text-[#5D4037] hover:bg-[#F8F9FA]">
          <svg class="w-3.5 h-3.5 text-[#5D4037]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
          <span>Kamus Metadata</span>
        </button>

        <button id="btn-header-registry" class="gov-btn text-xs font-medium bg-white border-[#E5DACF] text-[#5D4037] hover:bg-[#F8F9FA]">
          <svg class="w-3.5 h-3.5 text-[#5D4037]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
          <span>Source Registry</span>
        </button>

        <button id="btn-header-crosswalk" class="gov-btn text-xs font-medium bg-white border-[#E5DACF] text-[#5D4037] hover:bg-[#F8F9FA]">
          <svg class="w-3.5 h-3.5 text-[#5D4037]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
          <span>Crosswalk</span>
        </button>
      </div>
    </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div class="lg:col-span-4 space-y-2.5">
            <div class="flex items-center gap-2 flex-wrap text-[10px] font-mono uppercase tracking-widest text-[#8D6E63] font-bold">
              ...
              <span>•</span>
              <span class="inline-flex items-center gap-1.5 text-[#3D7B5E] normal-case font-semibold">
                <span class="inline-block w-2 h-2 rounded-full bg-[#3D7B5E] animate-pulse"></span>
            ...
            <div class="flex items-center gap-2 flex-wrap">
              ...
              <span class="text-[10px] font-mono font-bold uppercase px-2 py-0.5 rounded bg-[#EBF1FC] text-[#0038A8] border border-[#BCD0F7]">
                indoekonomi.data.go.id
              </span>
              <span class="text-[10px] font-mono font-semibold px-2 py-0.5 rounded bg-[#F8F9FA] text-[#5D4037] border border-[#E5DACF] inline-flex items-center gap-1">
                <span class="text-[#7D655C] font-normal lowercase">supported by</span>
                <span class="font-semibold uppercase text-[#5D4037]">Dewan Ekonomi Nasional</span>
              </span>
            </div>
            <p class="text-xs text-[#5D4037]/90 font-sans leading-relaxed">
          ...
          <div class="lg:col-span-2 space-y-2.5">
            ...
            <ul class="text-xs text-[#5D4037] font-sans space-y-1.5">
          ...
          <div class="lg:col-span-3 space-y-2.5">
            ...
            <p class="text-[11px] text-[#8D6E63] font-sans">
          ...
          <div class="lg:col-span-3 space-y-2.5 flex flex-col justify-between">
            <div class="space-y-1.5">
              ...
              <div class="text-[11px] text-[#7D655C]">
                Helpdesk: <a href="mailto:lubis.tania@dewanekonomi.go.id" class="text-[#0038A8] hover:underline font-medium">lubis.tania@dewanekonomi.go.id</a>
              </div>
            </div>
