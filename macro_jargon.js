...
const MACRO_JARGON_DATA = {
    ...
    demand_pull_inflation: {
        ...
        formula: "AD > AS \\\\implies P \\\\uparrow \\\\quad \\\\text{pada kondisi } Y \\\\approx Y^*",
    ...
    cost_push_inflation: {
        ...
        formula: "\\\\Delta \\\\text{Biaya Input} \\\\implies \\\\text{SRAS geser kiri} \\\\implies P \\\\uparrow, Y \\\\downarrow",
    ...
    mpc_konsumsi: {
        ...
        formula: "MPC = \\\\frac{\\\\Delta C}{\\\\Delta Y_d} \\\\quad | \\\\quad MPC + MPS = 1",
    ...
    distorsi_pasar: {
        ...
        formula: "Q_{\\\\text{pasar}} < Q_{\\\\text{keseimbangan}} \\\\implies P_{\\\\text{pasar}} \\\\gg P_{\\\\text{wajar}}",
    ...
    efek_substitusi: {
        ...
        formula: "\\\\frac{P_X}{P_Y} \\\\uparrow \\\\implies Q_X \\\\downarrow, Q_Y \\\\uparrow \\\\quad \\\\text{(Efek Substitusi Murni)}",
    ...
    biaya_logistik: {
        ...
        formula: "P_{\\\\text{konsumen}} = P_{\\\\text{produsen}} + \\\\text{Biaya Transportasi} + \\\\text{Margin Distribusi}",
    ...
    hukum_engel: {
        ...
        formula: "\\\\text{Pangsa Pangan} = \\\\frac{\\\\text{Belanja Makanan}}{\\\\text{Total Pengeluaran}} \\\\downarrow \\\\quad \\\\text{saat Pendapatan } Y \\\\uparrow",
    ...
    tabungan_investasi: {
        ...
        formula: "S_{\\\\text{nasional}} = S_{\\\\text{swasta}} + S_{\\\\text{pemerintah}} = (Y - T - C) + (T - G) = I + NX",
    ...
    ilusi_uang: {
        ...
        formula: "W_{\\\\text{riil}} = \\\\frac{W_{\\\\text{nominal}}}{P} \\\\quad | \\\\quad \\\\%\\\\Delta W_{\\\\text{riil}} \\\\approx \\\\%\\\\Delta W - \\\\pi",
    ...
    barang_inferior: {
        ...
        formula: "E_I = \\\\frac{\\\\%\\\\Delta Q}{\\\\%\\\\Delta Y} < 0 \\\\quad \\\\implies \\\\quad Y \\\\downarrow \\\\implies Q \\\\uparrow",
    ...
    eksternalitas_negatif: {
        ...
        formula: "\\\\text{SMC} = \\\\text{PMC} + \\\\text{Eksternalitas Negatif} \\\\quad (\\\\text{SMC} > \\\\text{PMC})",
    ...
    buffer_stock: {
        ...
        formula: "\\\\text{Keseimbangan Pasar: } S_{\\\\text{total}} = S_{\\\\text{petani}} + \\\\Delta \\\\text{Buffer Stock Pemerintah}",
    ...
    indeks_keyakinan_konsumen: {
        ...
        formula: "\\\\text{IKK} = \\\\frac{\\\\text{Indeks Kondisi Saat Ini (IKE)} + \\\\text{Indeks Ekspektasi Konsumen (IEK)}}{2} \\\\quad (>100 = \\\\text{Optimis})",
    ...
    barang_publik: {
        ...
        formula: "\\\\text{Ciri Barang Publik: } \\\\text{Non-Rivalry} \\\\; (MC=0) \\\\quad \\\\& \\\\quad \\\\text{Non-Excludability}",
    ...
    elastisitas_permintaan: {
        ...
        formula: "E_d = \\\\frac{\\\\%\\\\Delta Q}{\\\\%\\\\Delta P} \\\\quad | \\\\quad |E_d| < 1 \\\\implies \\\\text{Inelastis Sempurna / Parsial}",
    ...
    sektor_informal: {
        ...
        formula: "\\\\text{Tingkat Pengangguran Terbuka Rendah} \\\\iff \\\\text{Pangsa Tenaga Kerja Informal Tinggi (~55-60%)}",
    ...
    menu_costs: {
        ...
        formula: "\\\\text{Harga disesuaikan HANYA JIKA: } \\\\Delta \\\\text{Laba Tambahan} > \\\\text{Menu Costs}",
    ...
    supply_shock_elnino: {
        ...
        formula: "\\\\text{El Nino} \\\\implies Y_{\\\\text{pangan}} \\\\downarrow \\\\implies P_{\\\\text{beras}} \\\\uparrow \\\\implies \\\\text{Inflasi Volatile Foods} \\\\uparrow",
    ...
    kebijakan_penawaran: {
        ...
        formula: "\\\\text{Supply-Side Reform} \\\\implies \\\\text{LRAS geser kanan} \\\\implies Y^* \\\\uparrow \\\\; \\\\& \\\\; P \\\\downarrow",
    ...
    inklusi_keuangan: {
        ...
        formula: "\\\\text{Rasio Inklusi Keuangan} = \\\\frac{\\\\text{Penduduk Dewasa Memiliki Rekening}}{\\\\text{Total Penduduk Dewasa}} \\\\times 100\\\\%",
    ...
    kesejahteraan_sosial: {
        ...
        formula: "\\\\max W = f(\\\\text{PDB Riil}, \\\\text{Stabilitas Harga}, \\\\text{Penyerapan Kerja}, 1 - \\\\text{Gini})",
    ...
    forward_guidance: {
        ...
        formula: "i_{t+k}^e = E_t[i_{t+k} \\mid \\text{Forward Guidance}]",
    ...
    transmisi_kredit: {
        ...
        formula: "\\Delta \\text{Likuiditas Bank} \\implies \\Delta \\text{Penyaluran Kredit (Lending)} \\implies \\Delta I, \\Delta C",
    ...
    makroprudensial_ltv: {
        ...
        formula: "\\text{LTV} = \\frac{\\text{Plafon Kredit}}{\\text{Nilai Taksasi Agunan}} \\times 100\\%",
    ...
    pengetatan_kuantitatif: {
        ...
        formula: "\\Delta \\text{Neraca Bank Sentral} < 0 \\implies \\Delta \\text{Uang Primer (M0)} < 0",
    ...
    transmisi_nilai_tukar: {
        ...
        formula: "i \\uparrow \\implies \\text{Capital Inflow} \\implies E (\\text{Rupiah}) \\uparrow \\implies P_{\\text{impor}} \\downarrow, NX \\downarrow",
    ...
    jangkar_inflasi: {
        ...
        formula: "E_t[\\pi_{t+1}] = \\pi^* \\quad \\text{(Ekspektasi Inflasi Terjangkar Penuh)}",
    ...
    uang_primer: {
        ...
        formula: "M0 = C + R \\quad | \\quad M1 = M0 \\times mm \\quad (mm = \\text{Money Multiplier})",
    ...
    beban_bunga_perbankan: {
        ...
        formula: "\\text{NIM} = \\frac{\\text{Pendapatan Bunga Bersih}}{\\text{Total Rata-rata Aset Produktif}} \\times 100\\%",
    ...
    pasar_repo: {
        ...
        formula: "\\text{Repo Rate} = \\frac{P_{\\text{beli kembali}} - P_{\\text{jual awal}}}{P_{\\text{jual awal}}} \\times \\frac{360}{\\text{Tenor (hari)}}",
    ...
    kontrasiklikal_makroprudensial: {
        ...
        formula: "\\text{Penyangga Tambahan: } 0\\% \\le \\text{CCyB} \\le 2.5\\% \\times \\text{Aset Tertimbang Menurut Risiko (ATMR)}",
    ...
    cbdc_rupiah_digital: {
        ...
        formula: "\\text{Total Basis Moneter} = \\text{Uang Kartal Fisik} + \\text{Giro Bank di BI} + \\text{Rupiah Digital}",
    ...
    kurva_imbal_hasil: {
        ...
        formula: "\\text{Spread Imbal Hasil} = Y_{10\\text{Y}} - Y_{2\\text{Y}} \\quad (<0 \\implies \\text{Inversi Kurva})",
    ...
    moral_suasion: {
        ...
        formula: "\\text{Kepatuhan Sektor Perbankan} = f(\\text{Kredibilitas Otoritas}, \\text{Sanksi Reputasi})",
    ...
    kebijakan_makroprudensial: {
        ...
        formula: "\\text{RIM} = \\frac{\\text{Kredit} + \\text{Surat Berharga Korporasi}}{\\text{Dana Pihak Ketiga (DPK)} + \\text{Surat Berharga yang Diterbitkan}} \\times 100\\%",
    ...
    independensi_bank_sentral: {
        ...
        formula: "\\text{Indeks Independensi Tinggi} \\iff \\text{Rata-rata Inflasi Jangka Panjang Rendah}",
    ...
    transmisi_aset: {
        ...
        formula: "\\text{Tobin's } q = \\frac{\\text{Nilai Pasar Perusahaan}}{\\text{Biaya Penggantian Modal Fisik}} \\quad (q > 1 \\implies \\text{Investasi Pabrik Baru Untung})",
    ...
    fasilitas_simpanan_bi: {
        ...
        formula: "\\text{Koridor Suku Bunga: } \\text{DF Rate} \\le \\text{IndONIA} \\le \\text{Lending Facility Rate}",
    ...
    seigniorage: {
        ...
        formula: "\\text{Seigniorage} = \\Delta M \\times \\frac{P}{M} \\quad \\text{atau} \\quad \\text{Nilai Nominal} - \\text{Biaya Produksi Fisik}",
    ...
    shadow_banking: {
        ...
        formula: "\\text{Risiko Sistemik} = f(\\text{Ukuran Shadow Banking}, \\text{Tingkat Leverage}, \\text{Interkonektivitas})",
    ...
    intervensi_sterilisasi: {
        ...
        formula: "\\Delta \\text{Cadangan Devisa} + \\Delta \\text{Aset Domestik Bersih} = 0 \\implies \\Delta M0 = 0",
    ...
    stabilitas_sistem_keuangan: {
        ...
        formula: "\\text{SSK Terjaga} \\iff \\text{Risiko Sistemik Terkendali} \\; \\& \\; \\text{Fungsi Intermediasi Berjalan Normal}",
    ...
    dana_alokasi_khusus: {
        ...
        formula: "\\text{TKD} = \\text{DAU} + \\text{DAK Fisik/Non-Fisik} + \\text{DBH} + \\text{Dana Desa} + \\text{Dana Otonomi Khusus}",
    ...
    anggaran_kesehatan: {
        ...
        formula: "\\text{PBI JKN} = \\text{Subsidi Iuran Kas Negara} \\times 96.8 \\text{ Juta Jiwa Warga Miskin}",
    ...
    rasio_utang_negara: {
        ...
        formula: "\\text{Debt-to-GDP Ratio} = \\frac{\\text{Total Utang Pemerintah}}{\\text{PDB Nominal}} \\times 100\\% \\quad (\\le 60\\%)",
    ...
    anggaran_berimbang: {
        ...
        formula: "\\Delta Y = \\left( \\frac{1}{1 - MPC} \\right) \\Delta G - \\left( \\frac{MPC}{1 - MPC} \\right) \\Delta T = \\Delta G \\quad (\\text{jika } \\Delta G = \\Delta T)",
    ...
    dana_abadi: {
        ...
        formula: "\\text{Dana Abadi}_{t} = \\text{Dana Abadi}_{t-1} + \\text{Akumulasi Hasil Kelolaan Bersih} - \\text{Penyaluran Manfaat}",
    ...
    pembelian_sbn_bi: {
        ...
        formula: "\\text{Pasar Perdana: } \\text{Kemenkeu Terbitkan SBN} \\implies \\text{BI Beli Langsung} \\implies \\text{Dana Mengalir ke Belanja Darurat}",
    ...
    kurva_laffer: {
        ...
        formula: "\\text{Penerimaan Pajak } T = t \\times B(t) \\quad | \\quad \\exists \\, t^* \\text{ di mana } \\frac{dT}{dt} = 0",
    ...
    fiskal_ruang_gerak: {
        ...
        formula: "\\text{Fiscal Space} = \\text{Total Pendapatan Negara} - \\text{Belanja Mengikat (Mandatory Spending)} - \\text{Cicilan Bunga Utang}",
    ...
    belanja_mengikat: {
        ...
        formula: "\\text{Mandatory Spending Target: } \\text{Pendidikan} \\ge 20\\% \\text{ APBN} \\; (\\text{UUD 1945})",
    ...
    efisiensi_birokrasi: {
        ...
        formula: "\\text{Efisiensi} = \\frac{\\text{Output Layanan Publik}}{\\text{Belanja Barang \\& Pegawai (APBN)}} \\uparrow",
    ...
    sal_apbn: {
        ...
        formula: "\\text{SAL}_t = \\text{SAL}_{t-1} + \\text{SiLPA}_t - \\text{Penggunaan SAL}_t",
    ...
    pajak_karbon: {
        ...
        formula: "\\text{Tarif Minimal di Indonesia: Rp 30 per kilogram } CO_2e \\quad (\\text{UU HPP No. 7/2021})",
    ...
    pembiayaan_kreatif: {
        ...
        formula: "\\text{Kebutuhan Pembiayaan} = \\text{APBN} + \\text{Investasi BUMN} + \\text{Pembiayaan Kreatif Swasta (PINA/KPBU)}",
    ...
    kepatuhan_pajak: {
        ...
        formula: "\\text{Tingkat Kepatuhan} = \\frac{\\text{Jumlah SPT Tahunan Disampaikan}}{\\text{Wajib Pajak Wajib SPT}} \\times 100\\%",
    ...
    belanja_bansos: {
        ...
        formula: "\\Delta \\text{Konsumsi Desil 1-2} \\approx \\text{Nilai Transfer Bansos} \\times MPC_{\\text{miskin}} \\quad (MPC \\approx 1.0)",
    ...
    audit_bpk: {
        ...
        formula: "\\text{Opini Audit: WTP (Terbaik)} > \\text{WDP} > \\text{Tidak Wajar (TW)} > \\text{Menolak Berpendapat (Disclaimer)}",
    ...
    debt_sustainability: {
        ...
        formula: "\\Delta d = (r - g) d - pb \\quad | \\quad d = \\text{Rasio Utang/PDB}, \\; pb = \\text{Keseimbangan Primer/PDB}",
    ...
    belanja_infrastruktur: {
        ...
        formula: "\\text{Multiplier Fiskal Infrastruktur Jangka Panjang: } \\frac{\\Delta Y}{\\Delta G_{\\text{infra}}} \\approx 1.5 - 2.0",
    ...
    pajak_daerah: {
        ...
        formula: "\\text{Kemandirian Fiskal Daerah} = \\frac{\\text{Pendapatan Asli Daerah (PAD)}}{\\text{Total Pendapatan APBD}} \\times 100\\%",
    ...
    skema_kpbu: {
        ...
        formula: "\\text{Total Biaya Investasi} = \\text{Ekuitas Swasta} + \\text{Pinjaman Sindikasi Bank} + \\text{VGF (Dukungan Kelayakan Pemerintah)}",
    ...
    risiko_kontinjensi: {
        ...
        formula: "\\text{Total Beban Kontinjensi} = \\sum (\\text{Nilai Penjaminan}_i \\times \\text{Probabilitas Gagal Bayar}_i)",
    ...
    kedaulatan_fiskal: {
        ...
        formula: "\\text{Tingkat Kemandirian Fiskal} = \\frac{\\text{Pendapatan Pajak Domestik}}{\\text{Total Belanja Negara}} \\times 100\\%",
    ...
    hilirisasi_komoditas: {
        ...
        formula: "\\text{Nilai Tambah} = \\text{Harga Jual Produk Olahan (O)} - \\text{Biaya Bahan Mentah (I)} \\gg 0",
    ...
    dhe_sda: {
        ...
        formula: "\\text{Penempatan Wajib DHE} \\ge 30\\% \\times \\text{Nilai Devisa Ekspor} \\quad (\\text{Tenor Minimal 3 Bulan})",
    ...
    terms_of_trade: {
        ...
        formula: "\\text{ToT} = \\frac{P_{\\text{ekspor}}}{P_{\\text{impor}}} \\times 100",
    ...
    interest_rate_parity: {
        ...
        formula: "\\frac{F - S}{S} \\approx i_{\\text{domestik}} - i_{\\text{asing}} \\quad (F = \\text{Forward Kurs}, \\; S = \\text{Spot Kurs})",
    ...
    fdi_investasi: {
        ...
        formula: "\\text{Arus FDI Bersih} = \\text{Modal Masuk Pembelian Aset Fisik Asing} - \\text{Divestasi Keluar}",
    ...
    repatriasi_keuntungan: {
        ...
        formula: "\\text{Neraca Pendapatan Primer} = \\text{Pendapatan WNI di Luar Negeri} - \\text{Repatriasi Laba/Bunga Asing}",
    ...
    currency_swap: {
        ...
        formula: "\\text{Fasilitas BCSA} = \\text{BI Menyerahkan Rupiah} \\iff \\text{Bank Sentral Mitra Menyediakan Valas}",
    ...
    remitansi_tki: {
        ...
        formula: "\\Delta \\text{Neraca Pendapatan Sekunder} = \\text{Remitansi PMI Masuk} - \\text{Transfer Keluar WNA}",
    ...
    perjanjian_fta: {
        ...
        formula: "\\text{Tarif Bea Masuk} \\to 0\\% \\implies \\text{Trade Creation} > \\text{Trade Diversion}",
    ...
    taper_tantrum: {
        ...
        formula: "\\Delta \\text{Yield US Treasury} \\uparrow \\implies \\text{Capital Outflow dari Emerging Markets} \\implies \\text{Kurs Depresiasi Tajam}",
    ...
    peringkat_utang: {
        ...
        formula: "\\text{Kategori Rating: AAA > AA > A > BBB (Batas Investment Grade)} \\mid \\text{BB > B > CCC (Junk Bond)}",
    ...
    premi_cds: {
        ...
        formula: "\\text{Spread CDS} \\propto \\text{Probabilitas Default Negara} \\times (1 - \\text{Tingkat Pemulihan Aset})",
    ...
    hukum_satu_harga: {
        ...
        formula: "e = \\frac{P_{\\text{domestik}}}{P_{\\text{asing}}} \\quad \\iff \\quad \\text{Nilai Tukar Riil } \\epsilon = e \\times \\frac{P^*}{P} = 1",
    ...
    kurs_reer: {
        ...
        formula: "\\text{REER} = \\prod_{i=1}^N \\left( \\frac{S_i \\cdot P}{P_i^*} \\right)^{w_i} \\quad (w_i = \\text{Bobot Perdagangan Mitra } i)",
    ...
    komoditas_supercycle: {
        ...
        formula: "\\text{Durasi Siklus: } 10 - 20 \\text{ Tahun (Fase Ekspansi Melampaui Siklus Bisnis Biasa)}",
    ...
    larangan_ekspor_mentah: {
        ...
        formula: "\\text{Kebijakan Larangan: Ekspor Bijih Mentah} = 0 \\implies \\text{Investasi Smelter Masuk} \\implies \\text{Ekspor Olahan Metal} \\uparrow",
    ...
    devaluasi_kompetitif: {
        ...
        formula: "e \\downarrow \\implies P_{\\text{ekspor dalam USD}} \\downarrow \\implies NX \\uparrow \\quad (\\text{Memancing Pembalasan Negara Lain})",
    ...
    investasi_portofolio: {
        ...
        formula: "\\text{Arus Portofolio Bersih} = \\text{Beli Bersih Asing di Saham \\& SBN} - \\text{Jual Bersih Asing}",
    ...
    global_value_chains: {
        ...
        formula: "\\text{Partisipasi GVC} = \\frac{\\text{Kandungan Asing dalam Ekspor} + \\text{Kandungan Domestik dalam Ekspor Negara Lain}}{\\text{Total Ekspor}}",
    ...
    risk_free_rate: {
        ...
        formula: "\\text{Yield SBN Indonesia} = \\text{US Treasury Rate (Risk-Free)} + \\text{Premi Risiko Negara (CDS / Spread)}",
    ...
    swasembada_pangan: {
        ...
        formula: "\\text{Tingkat Swasembada (SSR)} = \\frac{\\text{Produksi Domestik}}{\\text{Produksi Domestik} + \\text{Impor} - \\text{Ekspor}} \\times 100\\% \\quad (\\ge 100\\%)",
    ...
    utang_valas_swasta: {
        ...
        formula: "\\text{Rasio Lindung Nilai Wajib} \\ge 25\\% \\times \\text{Selisih Negatif Aset Valas vs Kewajiban Valas Jatuh Tempo 6 Bulan}",
    ...
    diversifikasi_mitra: {
        ...
        formula: "\\text{Indeks Diversifikasi Pasar: Penurunan Konsentrasi Ekspor Herfindahl-Hirschman (HHI)}",
    ...
    ketahanan_eksternal: {
        ...
        formula: "\\text{Ketahanan Eksternal} = f(\\text{Kecukupan Cadev}, \\text{Surplus Neraca Dagang}, \\text{Rasio ULN Sehat}, \\text{DHE SDA Kuat})",
    ...
    pandemi_shock: {
        ...
        formula: "\\text{Double Shock} = \\text{Supply Shock} \\; (AS \\text{ anjlok}) \\; + \\; \\text{Demand Shock} \\; (AD \\text{ runtuh})",
    ...
    relaksasi_defisit: {
        ...
        formula: "\\text{Defisit APBN 2020} = 6.14\\% \\text{ PDB} \\implies \\text{Konsolidasi Fiskal 2022: } 2.38\\% \\text{ PDB (Kembali <3%)}",
    ...
    burden_sharing: {
        ...
        formula: "\\text{Beban Bunga Ditanggung BI: Kupon } 0\\% \\text{ untuk Belanja Public Goods (SKB I, II, \\& III)}",
    ...
    wage_price_spiral: {
        ...
        formula: "P_t \\uparrow \\implies W_{t+1} \\uparrow \\implies \\text{Biaya Produksi} \\uparrow \\implies P_{t+2} \\uparrow \\quad (\\text{Spiral Tak Berujung})",
    ...
    histeresis_pengangguran: {
        ...
        formula: "\\Delta \\text{NAIRU} > 0 \\quad \\text{setelah krisis berkepanjangan (Bekas Luka Resesi / Scarring Effects)}",
    ...
    sovereign_debt_crisis: {
        ...
        formula: "\\text{Default Risk} \\to 100\\% \\implies \\text{Yield SBN Meroket} \\implies \\text{Pemerintah Kehilangan Akses Pasar Keuangan}",
    ...
    balance_sheet_recession: {
        ...
        formula: "\\min \\text{Utang (Debt Minimization)} \\gg \\max \\text{Laba (Profit Maximization)}",
    ...
    restrukturisasi_kredit: {
        ...
        formula: "\\text{NPL Terjaga Rendah (<3%)} \\iff \\text{Plafon Restrukturisasi OJK Menampung Debitur Terdampak}",
    ...
    cadangan_beras_pemerintah: {
        ...
        formula: "\\text{Stok Akhir Bulog} = \\text{Stok Awal} + \\text{Serapan Petani Domestik} + \\text{Impor Penugasan} - \\text{Penyaluran SPHP/Bansos} \\ge 1.5 \\text{ Juta Ton}",
    ...
    subsidi_energi: {
        ...
        formula: "\\Delta \\text{ICP} = +\\text{US\\$ 1/barel} \\implies \\text{Beban Belanja Subsidi \\& Kompensasi Energi Naik Triliunan Rupiah}",
    ...
    just_energy_transition: {
        ...
        formula: "\\text{Komitmen Pendanaan JETP Indonesia} = \\text{US\\$ 20 Miliar (Campuran Hibah, Pinjaman Lunak, \\& Investasi Swasta)}",
    ...
    deflationary_spiral: {
        ...
        formula: "\\pi < 0 \\implies r_{\\text{riil}} = i - (-\\pi) = i + |\\pi| \\gg 0 \\implies C \\downarrow, I \\downarrow",
    ...
    ketahanan_pangan: {
        ...
        formula: "\\text{Indeks Ketahanan Pangan (IKP)} = f(\\text{Ketersediaan}, \\text{Keterjangkauan Harga}, \\text{Kualitas \\& Pemanfaatan Gizi})",
    ...
    car_perbankan: {
        ...
        formula: "\\text{CAR} = \\frac{\\text{Modal Bank (Tier 1 + Tier 2)}}{\\text{Aset Tertimbang Menurut Risiko (ATMR)}} \\times 100\\% \\quad (\\ge 8\\%)",
    ...
    umkm_ketahanan: {
        ...
        formula: "\\text{Pangsa UMKM: } 61\\% \\text{ PDB} \\; \\& \\; 97\\% \\text{ Tenaga Kerja Nasional}",
    ...
    kemiskinan_stunting: {
        ...
        formula: "\\text{Target Nasional: Kemiskinan Ekstrem } \\to 0\\% \\quad \\& \\quad \\text{Prevalensi Stunting } < 14\\%",
    ...
    biaya_transaksi_eodb: {
        ...
        formula: "\\text{Biaya Transaksi Turun} \\implies \\text{Efisiensi Modal Meningkat (ICOR Turun)} \\implies \\text{Pertumbuhan PDB Melaju}",
    ...
    dedolarisasi: {
        ...
        formula: "\\% \\text{Pangsa USD dalam Transaksi Eksternal} \\downarrow \\iff \\% \\text{Pangsa Yuan, Yen, Won, \\& Mata Uang Lokal} \\uparrow",
    ...
    kemandirian_fiskal: {
        ...
        formula: "\\text{Rasio Kemandirian} = \\frac{\\text{Penerimaan Perpajakan Domestik}}{\\text{Total Belanja Negara}} \\to 100\\%",
    ...
    resiliensi_rantai_pasok: {
        ...
        formula: "\\text{TKDN} \\ge 40\\% \\implies \\text{Kekebalan Industri Manufaktur terhadap Disrupsi Global}",
    ...
    peran_bumn: {
        ...
        formula: "\\text{Nilai Tambah BUMN} = \\text{Dividen Kas Negara} + \\text{Setoran Pajak} + \\text{Dampak Kemanfaatan Sosial (Public Service Obligation)}",
    ...
    black_swan_resilience: {
        ...
        formula: "\\text{Resiliensi} = f(\\text{Bantalan Fiskal (SAL)}, \\text{Bantalan Moneter (Cadev)}, \\text{Ketahanan Modal Bank (CAR)}, \\text{Kecepatan Respon Kebijakan})",
    ...
    middle_income_trap: {
        ...
        formula: "\\text{Lolos MIT} \\iff \\text{PDB per Kapita} > \\text{US\\$ 13.845} \\; \\& \\; \\text{TFP (Total Factor Productivity)} \\uparrow",
    ...
    teknokrat_den: {
        ...
        formula: "\\text{Mahakarya Teknokrat} = \\text{Integritas Moral} + \\text{Kompetensi Ilmiah} + \\text{Keberanian Eksekusi} \\implies \\text{Indonesia Maju 2045}",
